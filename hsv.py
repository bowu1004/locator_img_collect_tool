...
img1 = cv.imread("dataset/train/coco_cola/00004.png")
img1 = img2_minAreaRect_roi(img1)
img1 = handle_img(img1)
# cv.imshow("img1", img1)

img2 = cv.imread("dataset/template/coco_template.png")
img2 = handle_img(img2)
# cv.imshow("img2", img2)

img3 = cv.imread("dataset/template/mozhua_template.png")
img3 = handle_img(img3)
# cv.imshow("img3", img3)

img4 = cv.imread("dataset/template/kaishui.png")
...
hist_compare(hist1, hist3)
hist_compare(hist1, hist4)
