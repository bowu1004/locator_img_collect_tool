...
class Model(nn.Module):
    ...
    def __call__(self, source=None, source2=None, stream=False, **kwargs):
        """Calls the 'predict' function with given arguments to perform object detection."""
        return self.predict(source, source2, stream, **kwargs)
    ...
    def predict(self, source=None, source2=None, stream=False, predictor=None, **kwargs):
        """
        ...
        return self.predictor.predict_cli(source=source, source2=source2) if is_cli else self.predictor(source=source, source2=source2, stream=stream)
